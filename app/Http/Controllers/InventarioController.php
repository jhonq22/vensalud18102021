...
public function import() 
    ...
    public function ReporteInventarioCentroSalud($centro_salud_id, $fecha1, $fecha2)
    {
      ...
      public function ReporteInventarioGeneralPorEstatus($equipo,$estatu_equipo_id, $fecha1, $fecha2, $fecha3, $fecha4)
      {
        ...
        $equipo = '%'.$equipo.'%';  
          ...
          LEFT JOIN equipos ON inventarios.equipo_id = equipos.id
          LEFT JOIN marcas ON inventarios.marca_id = marcas.id
          WHERE equipos.equipo LIKE ? AND inventarios.estatu_equipo_id = ? AND 
          (DATE(historico_estatus.created_at) BETWEEN  ? AND ? OR
           DATE(historico_estatus.updated_at) BETWEEN  ? AND ?)
          ORDER BY inventarios.id DESC", [$equipo, $estatu_equipo_id, $fecha1, $fecha2, $fecha3, $fecha4]);
      ...
      public function ReporteInventarioEstadalPorEstatus($equipo, $estado_id, $estatu_equipo_id, $fecha1, $fecha2, $fecha3, $fecha4)
      {
        ...
        $equipo = '%'.$equipo.'%';  
          ...
          LEFT JOIN equipos ON inventarios.equipo_id = equipos.id
          LEFT JOIN marcas ON inventarios.marca_id = marcas.id
          WHERE equipos.equipo LIKE ? AND inventarios.estado_id = ?  AND inventarios.estatu_equipo_id = ? AND 
          (DATE(historico_estatus.created_at) BETWEEN  ? AND ? OR
           DATE(historico_estatus.updated_at) BETWEEN  ? AND ?)
          ORDER BY inventarios.id DESC", [$equipo, $estado_id, $estatu_equipo_id, $fecha1, $fecha2, $fecha3, $fecha4 ]);
  
          echo json_encode($inventarios); // para pasar en json
      }
  
  
      public function ReporteInventarioMunicipalPorEstatus($equipo, $municipio_id, $estatu_equipo_id, $fecha1, $fecha2, $fecha3, $fecha4)
      {
        $equipo = '%'.$equipo.'%'; 
          $inventarios = DB::select("SELECT  historico_estatus.inventario_id, centro_salud, estado, servicio_medico, equipo, marca, serial, numero_bien_nacional, reparado, estatu_equipo, historico_estatus.observacion, historico_estatus.created_at
          FROM historico_estatus
          ...
          LEFT JOIN equipos ON inventarios.equipo_id = equipos.id
          LEFT JOIN marcas ON inventarios.marca_id = marcas.id
          WHERE equipos.equipo LIKE ? AND inventarios.municipio_id = ?  AND inventarios.estatu_equipo_id = ? AND 
          (DATE(historico_estatus.created_at) BETWEEN  ? AND ? OR
           DATE(historico_estatus.updated_at) BETWEEN  ? AND ?)
          ORDER BY inventarios.id DESC", [$equipo ,$municipio_id, $estatu_equipo_id, $fecha1, $fecha2, $fecha3, $fecha4] );
  
          echo json_encode($inventarios); // para pasar en json
      }
  
      public function ReporteInventarioCentroSaludPorEstatus($equipo ,$centro_salud_id, $estatu_equipo_id, $fecha1, $fecha2, $fecha3, $fecha4)
      {
        $equipo = '%'.$equipo.'%'; 
          $inventarios = DB::select("SELECT  historico_estatus.inventario_id, centro_salud, estado, servicio_medico, equipo, marca, serial, numero_bien_nacional, reparado, estatu_equipo, historico_estatus.observacion, historico_estatus.created_at
          FROM historico_estatus
          ...
          LEFT JOIN equipos ON inventarios.equipo_id = equipos.id
          LEFT JOIN marcas ON inventarios.marca_id = marcas.id
          WHERE equipos.equipo LIKE ? AND inventarios.centro_salud_id = ?  AND inventarios.estatu_equipo_id = ? AND 
          (DATE(historico_estatus.created_at) BETWEEN  ? AND ? OR
           DATE(historico_estatus.updated_at) BETWEEN  ? AND ?)
          ORDER BY inventarios.id DESC", [$equipo ,$centro_salud_id, $estatu_equipo_id, $fecha1, $fecha2, $fecha3, $fecha4] );
