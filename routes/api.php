...
Route::get('inventario/reportes/general/estatus/{equipo}/{estatu_equipo_id}/{fecha1}/{fecha2}/{fecha3}/{fecha4}', 'InventarioController@ReporteInventarioGeneralPorEstatus');


Route::get('inventario/reportes/estadal/estatus/{equipo}/{estado_id}/{estatu_equipo_id}/{fecha1}/{fecha2}/{fecha3}/{fecha4}', 'InventarioController@ReporteInventarioEstadalPorEstatus');

Route::get('inventario/reportes/municipal/estatus/{equipo}/{municipio_id}/{estatu_equipo_id}/{fecha1}/{fecha2}/{fecha3}/{fecha4}', 'InventarioController@ReporteInventarioMunicipalPorEstatus');

Route::get('inventario/reportes/centro_salud/estatus/{equipo}/{centro_salud_id}/{estatu_equipo_id}/{fecha1}/{fecha2}/{fecha3}/{fecha4}', 'InventarioController@ReporteInventarioCentroSaludPorEstatus');
